...
data = {
    ...
    'education': (
                     ('Английский','До уровня В2', 'Уже на протяжениии 6 лет я занимался Английским', 'СЕЙЧАС'),
                     ('Программирование','До Марта 2025','Этот сайт - домашка по этому доп. занятию', 'ЭТО ДОМАШКА ПО ПРОГРАМИРОВАНИЮ'),
